...
// UC08 — generate personalised example sentences for a word.
...
export function buildExamplesSpec(
  word: string,
  ...
  return {
    system:
      `You write example sentences that help a Vietnamese learner remember a word. ` +
