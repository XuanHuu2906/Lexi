...
// UC04 — look up & explain a word for a Vietnamese learner of English.
...
export function buildDictionarySpec(
  term: string,
  ...
  return {
    system:
      `You are a bidirectional English–Vietnamese dictionary for a learner at CEFR level ${level}. ` +
