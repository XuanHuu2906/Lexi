...
export interface PrismaClient<in LogOpts extends Prisma.LogLevel = never, in out OmitOpts extends Prisma.PrismaClientOptions['omit'] = undefined, in out ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> {
    ...
    get srsData(): Prisma.SrsDataDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    get reviewLog(): Prisma.ReviewLogDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    get toeicWord(): Prisma.ToeicWordDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    get conversationScenario(): Prisma.ConversationScenarioDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    get auditLog(): Prisma.AuditLogDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    get grammarRule(): Prisma.GrammarRuleDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    get quizResult(): Prisma.QuizResultDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    get conversationLog(): Prisma.ConversationLogDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
