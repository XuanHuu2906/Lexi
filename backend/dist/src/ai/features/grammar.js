...
exports.buildGrammarNormalizeSpec = buildGrammarNormalizeSpec;
exports.buildGrammarExamplesSpec = buildGrammarExamplesSpec;
...
function buildGrammarNormalizeSpec(rule) {
    return {
        system: `You turn a Vietnamese learner's note into a clean, reusable English grammar rule. ` +
...
function buildGrammarExamplesSpec(formula, explanation, count = 3) {
    return {
        system: `You generate example sentences that illustrate an English grammar rule for a Vietnamese learner. ` +
