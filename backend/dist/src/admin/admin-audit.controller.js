...
const list_audit_dto_1 = require("./dto/list-audit.dto");
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Audit trail, newest-first, read-only (UCA08)' }),
    __param(0, (0, common_1.Query)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [list_audit_dto_1.ListAuditDto]),
    __metadata("design:returntype", void 0)
], AdminAuditController.prototype, "list", null);
__decorate([
    (0, common_1.Get)('admins'),
    (0, swagger_1.ApiOperation)({ summary: 'Distinct admin emails present in the log' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], AdminAuditController.prototype, "admins", null);
